...
\begin{enumerate}[(i)]
\item test
% \item \begin{seg}{\emph{Proton-Proton Streuung}}
% Wir betrachten zum Beispiel die \emph{Proton-Proton Streuung}. Es gilt $m_1=m_2; v_2=0 \implies $ Folie: $90°$-Winkel Zerfall?.
...
% Energiesatz: $\frac{p_1^2}{2m_1}=\frac{p'_1}{2m_1}+\frax{p_2'}{2m_2}$
% \[
...
% \[
%  \to dp= d(m\cdot v) = \underbrace{m dv}_{dp_{Rakete}} + \underbrace{v dm}_{dp_{Gas}} \stackrel{!}=0
% \]
